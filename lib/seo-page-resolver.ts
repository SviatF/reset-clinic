    ...
    const nextSections = hasMasseterSection
      ...
      : [
          ...sections,
          {
            ...
            text: [
              "Запити про ботулінотерапію масетерів мають специфічну анатомічну задачу, але на поточному етапі не потребують окремої thin landing page. Зона описується всередині головної сторінки ботулінотерапії; рішення про доцільність корекції приймає лікар після оцінки м’язової активності, анатомії та показань.",
            ],
          },
        ];
