...
export const DOCTORS: DoctorProfile[] = [
  ...
  },
  {
    slug: "olha-hrytsuta",
    name: "Грицута Ольга",
    role: "Сімейний лікар та нутриціолог",
    image: "/assets/desktop-bf1ca5b5ac5207b027402bae1e00c2b8175e58c2.jpg",
    bio: "Допомагає знайти причини порушень самопочуття, скоригувати спосіб життя та харчування, а також покращити загальний стан здоров’я. Працює з профілактикою захворювань, метаболічними порушеннями, контролем ваги та формуванням індивідуальних рекомендацій, заснованих на принципах доказової медицини.",
    relatedPaths: [
      "/nutrition/",
